...
mainFrame.Size = UDim2.new(0, 280, 0, 580); mainFrame.Position = UDim2.new(0.5, -140, 0.5, -290)
...
local speedInput = Instance.new("TextBox", mainFrame); speedInput.Size = UDim2.new(0.9, 0, 0, 30); speedInput.Position = UDim2.new(0.05, 0, 0.45, 0); speedInput.PlaceholderText = "Tốc độ (30-40 recommended)"

local listFrame = Instance.new("ScrollingFrame", mainFrame); listFrame.Size = UDim2.new(0.9, 0, 0.25, 0); listFrame.Position = UDim2.new(0.05, 0, 0.15, 0); listFrame.BackgroundTransparency = 1

createButton("Lưu Vị Trí", UDim2.new(0.05, 0, 0.35, 0), function()
...
createButton("Áp dụng Tốc độ", UDim2.new(0.05, 0, 0.52, 0), function()
...
-- 5. CHỨC NĂNG KHÁC
createButton("Nhảy vô hạn: TẮT", UDim2.new(0.05, 0, 0.62, 0), function(btn)
...
createButton("Auto Gold: TẮT", UDim2.new(0.05, 0, 0.72, 0), function(btn)
...
createButton("Auto Rainbow: TẮT", UDim2.new(0.05, 0, 0.82, 0), function(btn)
